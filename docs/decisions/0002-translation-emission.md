...
The selected path is intentionally limited to arithmetic, branch, and bounded memory behavior. It is not PVM translation and does not introduce a Jambda or Native semantics change.
